...
function AboutPage() {
  ...
  return (
    <>
      <Helmet>
        <title>About Gopal Sanitary | 28+ Years of Excellence in Sanitary Solutions</title>
        <meta name="description" content="Learn about Gopal Sanitary - your trusted partner for premium sanitary products since 1995. Authorized retailer for Jaquar, VGUARD, KITEC and more. 28+ years of experience." />
        <meta name="keywords" content="about Gopal Sanitary, sanitary store history, trusted sanitary brand, Punjab sanitary shop" />
          ...
          <div className="container">
            <div className="story-content">
              ...
              <div className="story-image">
                <img loading="lazy" src="https://i.postimg.cc/VvfDrZP0/1-(2).jpg" alt="Luxury Bathroom - Gopal Sanitary" />
